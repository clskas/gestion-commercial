...
<div class="container">
    ...
    <div class="panel panel-primary margetop">
        <div class="panel-heading bg-primary text-white stron">
            Veuillez saisir les informations du nouveau fournisseur
        </div>
        <div class="panel-body">
            <form method="GET" class="form-inline" onsubmit="return verifForm(this);">
                ...
                <div class="form-group">
                    <button type="button" class="btn btn-primary stron" id="enregistrer" name="enregistrer" value="Enregistrer" style="margin-top:10px;" onclick="document.getElementById('param').value='inserer';chargementfournisseurs();">
