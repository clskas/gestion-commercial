            ...
            <div class="panel panel-primary margetop10">
                ...
                <div class="panel-body">                                                               
                        <form method="GET" class="form-inline" > 
                            ...
                            <div style="width:35%;height:20px;float:left;font-size:20px;font-weight:bold;text-align:left;color:#a13638;">
                                <u>Informations du client</u><br />
                            </div>                     
                            <div style="width:35%;height:50px;float:left;font-size:16px;font-weight:bold;text-align:left;">
                                <a href="nouveauclient.php" data-anijs="if: mouseover, do: swing animated">
                            ...
                            <div class="form-group">
                                ...
                                <div style="width:80%;height:30px;float:left;font-size:20px;font-weight:bold;text-align:left;color:#a13638;">
                                ...
                                <div class="form-group largeur100">
                                    ...
                                    <div >
                                        <label> Unité</label>
                                        <input type="text" class="form-control"  id="idunitefacture" name="idunitefacture" disabled/>
                                    </div> 
                                    &nbsp  &nbsp <!--Pour espacement--> 
                                    <div >
