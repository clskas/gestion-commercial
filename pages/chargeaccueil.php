...
if(isset($_GET["param"]))
{
    switch($_GET["param"])
    {
        case "tous": 
            ...
            $entrepriseinfo=$resultate->fetch();
            $libelleentreprise = $entrepriseinfo['nom_entreprise']; 
            $logoentreprise = $entrepriseinfo['logo']; 
            //Afficher le tableau au format JSON              
            echo json_encode(array("libelleentreprise"=>$libelleentreprise,"logo"=>$logoentreprise)); 
        break;
    }       
}
